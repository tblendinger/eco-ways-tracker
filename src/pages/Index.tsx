...
const Index = () => {
  ...
  // Auto-generate posts every 5 seconds when user is logged in
  useEffect(() => {
    ...
    const generateRandomPost = () => {
      const users = [
        ...
        "Sofia Natura", "Miguel Solar", "Carmen Bio", "Andrés Recicla"
      ];
      const actions = [
        "Usé transporte público hoy, reduciendo mis emisiones 🚌",
        "Comí vegano todo el día, ¡delicioso y sostenible! 🌱",
        "Recicle toda mi basura de la semana correctamente ♻️",
        "Ahorré agua con duchas más cortas 🚿💧",
        "Cambié a bombillas LED en toda mi casa 💡",
        "Usé mi bicicleta para ir al trabajo 🚲",
        "Compré productos locales en el mercado 🥕",
        "Planté un árbol en mi jardín 🌳"
      ];
